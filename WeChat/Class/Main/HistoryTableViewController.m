...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(loginStatusChange:) name:LoginStatusNotification object:nil];
}
- (void)loginStatusChange: (NSNotification *)notification {
    WCLog(@"%@",notification.object);
